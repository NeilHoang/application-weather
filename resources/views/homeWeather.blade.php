...
<div class="container">
    <div class="weather-side">
        ...
        <div class="date-container">
            <h2 class="date-dayname">Wednesday</h2><span class="date-day">06 Nov 2019</span>
    ...
    <div class="info-side">
        <div class="today-info-container">
            <div class="today-info">
                ...
                <div class="humidity"><span class="title">HUMIDITY</span><span class="value">{{$dataWeather->main->humidity}} %</span>
                    <div class="clear"></div>
                </div>
        ...
        <div class="week-container">
            <ul class="week-list">
                <li class="active">
                    ...
                    <span class="day-name">Tue</span><span class="day-temp">29°C</span></li>
                <li>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="location-container">
            <button class="location-button">
                ...
                <span>Change location</span></button>
        </div>
    </div>
</div>
<script
